                           ...
                           <div class="widget-body">
							  ...
							  <form action="" method="post">
                                 ...
                                 <div class="form-group col-sm-6">
                                       ...
                                       <input class="form-control" type="tel" maxlength="10" name="phone" id="example-tel-input-3" autocomplete="off" required >
                                 </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="#"> <img src="images\gpay.png" alt="Maestro"> </a>
                                </li>
                                <li>
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Contact us</h5>
                                    <p>If you have any query please contact us via Contact Number or Email</p>
                        </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                <h5>Contact No : +91 xxx-xxx-xxxx</h5>
                                    <h5>Email: onlinefood@gamil.com</h5>
                                </div>
                    </div>
                </div>
